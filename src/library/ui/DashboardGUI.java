...
public class DashboardGUI extends JFrame {
    ...
    private JPanel buildHeader() {
        ...
        logoutBtn.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                logoutBtn.setBackground(new Color(139, 20, 20));
            }
    ...
    private JPanel buildDashboardPanel() {
        ...
        // Title
        JLabel welcome = new JLabel("Library Dashboard — Overview");
        ...
        List<BorrowRecord> allRecords = borrowDAO.getAllRecords();
        ...
        cardsPanel.setBorder(BorderFactory.createEmptyBorder(0, 0, 15, 0));
        cardsPanel.add(createStatCard("📚 Total Books",
            String.valueOf(allBooks.size()),   new Color(70, 130, 180)));
        cardsPanel.add(createStatCard("👤 Total Members",
            String.valueOf(allMembers.size()),  new Color(46, 139, 87)));
        cardsPanel.add(createStatCard("📖 Active Borrows",
            String.valueOf(borrowed),           new Color(200, 120, 0)));
        cardsPanel.add(createStatCard("⚠ Overdue",
            String.valueOf(overdue.size()),     new Color(178, 34, 34)));
        ...
        if (allRecords.isEmpty()) {
            ...
            allRecords.stream().limit(5).forEach(r ->
        ...
        if (available.isEmpty()) {
            ...
            available.stream().limit(5).forEach(b ->
                availModel.addElement("  " + b.getBookId() +
                    ".  " + b.getTitle() +
                    " — " + b.getAuthor()));
        }
    ...
    private JPanel buildModulePanel(String moduleName) {
        ...
        JLabel label = new JLabel("Click below to manage " + moduleName);
        ...
        openBtn.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                openBtn.setBackground(new Color(20, 60, 120));
            }
            public void mouseExited(MouseEvent e) {
                openBtn.setBackground(new Color(30, 80, 140));
            }
        });
        openBtn.addActionListener(e -> new LibraryGUI().setVisible(true));
